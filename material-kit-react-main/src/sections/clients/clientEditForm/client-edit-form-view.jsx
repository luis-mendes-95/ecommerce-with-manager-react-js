  ...
  const renderForm = (
    <>
      ...
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth label="CNPJ" type="CNPJ" id="CNPJ" defaultValue={client.item.cnpj} inputProps={{ maxLength: 18 }} onInput={(e) => {
          ...
          {...register("cnpj")}
      />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("nome_razao_social")} defaultValue={client.item.nome_razao_social} name="nome_razao_social" label="Nome / Razão Social" type="nome_razao_social" id="nome_razao_social" inputProps={{ maxLength: 80 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase(); }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("apelido_nome_fantasia")} defaultValue={client.item.apelido_nome_fantasia} name="apelido_nome_fantasia" label="Apelido / Nome Fantasia" type="apelido_nome_fantasia" id="apelido_nome_fantasia" inputProps={{ maxLength: 80 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase(); }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("tags")} defaultValue={client.item.tags} name="tags" label="Tags (separe por vírgulas)" type="tags" id="tags" inputProps={{ maxLength: 80 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase(); }}/>
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("inscricao_estadual")}  defaultValue={client.item.inscricao_estadual} name="inscricao_estadual" label="Inscrição Estadual" type="text" id="inscricao_estadual" inputProps={{ maxLength: 50 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("inscricao_municipal")}  defaultValue={client.item.inscricao_municipal} name="inscricao_municipal" label="Inscrição Municipal" type="text" id="inscricao_municipal" inputProps={{ maxLength: 8 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("cep")}  defaultValue={client.item.cep} name="cep" label="CEP" type="text" id="cep" inputProps={{ maxLength: 20 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("rua")}   defaultValue={client.item.rua}name="rua" label="Rua" type="text" id="rua" inputProps={{ maxLength: 80 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase(); }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("numero")}   defaultValue={client.item.numero}name="numero" label="Nº" type="text" id="numero" inputProps={{ maxLength: 20 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("complemento")}  defaultValue={client.item.complemento} name="complemento" label="Complemento" type="text" id="complemento" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("bairro")}   defaultValue={client.item.bairro}name="bairro" label="Bairro" type="text" id="bairro" inputProps={{ maxLength: 40 }}onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("cidade")}  defaultValue={client.item.cidade} name="cidade" label="Cidade" type="text" id="cidade" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}}/>
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("estado")}   defaultValue={client.item.estado}name="estado" label="Estado" type="text" id="estado" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}}/>
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("telefone")}  defaultValue={client.item.telefone} name="telefone" label="Telefone" type="text" id="telefone" inputProps={{ maxLength: 40 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("celular")}  defaultValue={client.item.celular} name="celular" label="Celular" type="text" id="celular" inputProps={{ maxLength: 40 }} />
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("email")}   defaultValue={client.item.email}name="email" label="E-mail" type="text" id="celular" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}}/>
      <TextField style={{width:"200px", marginTop:"0"}} required fullWidth {...register("site")}   defaultValue={client.item.site} name="site" label="Site" type="text" id="site" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}}/>
      <TextField style={{width:"630px", marginTop:"0"}} required fullWidth {...register("descricao")}  defaultValue={client.item.descricao} name="descricao" label="Descrição" type="text" id="descricao" inputProps={{ maxLength: 40 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase();}}/>
