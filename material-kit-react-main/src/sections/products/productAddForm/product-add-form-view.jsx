...
const onFormSubmit = (formData) => {
  ...
  const renderForm = (
    <>
      ...
      <TextField style={{width:"100px", marginTop:"0"}} required fullWidth {...register("cod")} name="code" label="Código" type="code" id="code" inputProps={{ maxLength: 80 }} onInput={(e) => { e.target.value =  e.target.value.toUpperCase(); }} />
