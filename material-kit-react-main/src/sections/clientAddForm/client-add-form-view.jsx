...
const onFormSubmit = (formData) => {
  ...
  const renderForm = (
    <>
      ...
      <TextField style={{width:"180px", marginTop:"0"}} required fullWidth {...register("inscricao_estadual")} name="inscricao_estadual" label="Inscrição Estadual" type="text" id="inscricao_estadual" inputProps={{ maxLength: 50 }} />
      <TextField style={{width:"180px", marginTop:"0"}} required fullWidth {...register("inscricao_municipal")} name="inscricao_municipal" label="Inscrição Municipal" type="text" id="inscricao_municipal" inputProps={{ maxLength: 8 }} />
      <TextField style={{width:"180px", marginTop:"0"}} required fullWidth {...register("cep")} name="cep" label="CEP" type="text" id="cep" inputProps={{ maxLength: 20 }} />
      <TextField style={{width:"180px", marginTop:"0"}} required fullWidth {...register("rua")} name="rua" label="Rua" type="text" id="rua" inputProps={{ maxLength: 80 }} />
